  ...
  return (
    <div>
      <div
        ...
        id="skills-section"
      >
        <h3 className="text-gray-600 my-2 xl:text-2xl xl:my-3 font-semibold 2xl:text-4xl 2xl:my-5">
          SKILLS OVERVIEW
        </h3>
        <h1 className="white text-4xl mb-5 md:text-5xl xl:text-6xl font-bold xl:mb-9 2xl:text-9xl">
          My <span className="text-purple-400 ">Skills. </span>
        </h1>
        <p className="text-[12px]  text-gray-500 md:text-left md:text-sm xl:text-left xl:text-gray-500 font-light xl:font-normal xl:text-base xl:w-10/12 2xl:text-2xl">
      ...
      <div className="flex flex-wrap items-center mb-10 w-5/6 gap-10 mx-auto md:justify-center md:gap-7 md:w-11/12 xl:gap-10 xl:w-11/12 xl:justify-evenly">
        {/*  */}
        <div className="green-pink-gradient w-full md:w-2/5 h-56 xl:h-60 rounded-2xl p-[1px] flex-wrap xl:w-1/4 2xl:h-[25rem]">
          <div className="border border-purple-700 rounded-2xl h-full w-full ">
            <FaReact size={60} className="mx-auto mt-4 " />
            <div className="mx-2 my-2 2xl:my-8">
              <h3 className="my-2 text-xl text-center text-green-500 2xl:text-5xl 2xl:my-5">
                React
              </h3>
              <p className="xl:font-normal text-xs xl:text-sm font-light text-center text-gray-400 2xl:text-2xl">
